        ...
        {results && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {activeTab === 'analytics' && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold text-gray-800 text-center mb-6">📊 Advanced Analytics</h2>
                  ...
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">💰 Risk/Reward Analysis</h3>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="bg-green-50 p-4 rounded-lg">
                        <p className="text-gray-600 text-sm mb-1">Average Win</p>
                        <p className="text-2xl font-bold text-green-600">₹{results.riskReward.avgWin.toLocaleString()}</p>
                      </div>
                      <div className="bg-red-50 p-4 rounded-lg">
                        <p className="text-gray-600 text-sm mb-1">Average Loss</p>
                        <p className="text-2xl font-bold text-red-600">₹{results.riskReward.avgLoss.toLocaleString()}</p>
                      </div>
                  ...
                  {/* Equity Curve */}
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">📈 Equity Curve</h3>
                  ...
                  {/* Day of Week Analysis */}
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">📅 Day of Week Performance</h3>
                    <ResponsiveContainer width="100%" height={300}>
                  ...
                  {/* Hour-by-Hour Heatmap */}
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">🔥 Hour-by-Hour Performance Heatmap</h3>
                  ...
                  {/* Direction Analysis */}
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">📊 Direction Analysis</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between"><span>Total P&L:</span><span className="font-bold text-green-600">₹{results.direction.long.totalPnL.toLocaleString()}</span></div>
                          <div className="flex justify-between"><span>Win Rate:</span><span className="font-bold">{results.direction.long.winRate}%</span></div>
                          <div className="flex justify-between"><span>Avg P&L:</span><span className="font-bold">₹{results.direction.long.avgPnL.toLocaleString()}</span></div>
                        </div>
                      </div>
                      <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-lg border border-orange-200">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between"><span>Total P&L:</span><span className={`font-bold ${results.direction.short.totalPnL >= 0 ? 'text-green-600' : 'text-red-600'}`}>₹{results.direction.short.totalPnL.toLocaleString()}</span></div>
                          <div className="flex justify-between"><span>Win Rate:</span><span className="font-bold">{results.direction.short.winRate}%</span></div>
                          <div className="flex justify-between"><span>Avg P&L:</span><span className="font-bold">₹{results.direction.short.avgPnL.toLocaleString()}</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">⏱️ Trade Duration vs Profitability</h3>
                    <ResponsiveContainer width="100%" height={300}>
                  ...
                  {/* Best Trades */}
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">🏆 Top 5 Best Trades</h3>
                    <div className="space-y-2">
                      {results.bestWorstTrades.best.map((trade, idx) => (
                        <div key={idx} className="flex justify-between items-center p-3 bg-green-50 rounded-lg border border-green-200">
                          ...
                          <span className="font-bold text-green-600">₹{trade.pnl.toLocaleString()}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* Worst Trades */}
                  <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-md">
                    <h3 className="font-semibold text-lg text-gray-800 mb-4">⚠️ Top 5 Worst Trades</h3>
                    <div className="space-y-2">
                      {results.bestWorstTrades.worst.map((trade, idx) => (
                        <div key={idx} className="flex justify-between items-center p-3 bg-red-50 rounded-lg border border-red-200">
                          ...
                          <span className="text-sm text-gray-600">Trade #{trade.tradeNumber}</span>
                          <span className="font-bold text-red-600">₹{trade.pnl.toLocaleString()}</span>
                        </div>
                      ))}
                    </div>
                  </div>
